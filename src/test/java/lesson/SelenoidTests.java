...
public class SelenoidTests {
    ...
    */
    ...
    @Test
    void checkTotal() {
        given()// given when можно опустить
                .when()
    ...
    void checkTotalWithStatus() {
        given()
                ...
                .log().body()
                .statusCode(200)
                .body("total", is(20)); //проверка внутри запроса
    }
    ...
    void checkResponseGoodPractice() {
        ...
        assertEquals(expectedTotal, actualTotal); //проверка вне запроса
    }
...
//    then проверки
//
//    put например когда нужно вставить комментарий
//    patch - когда обновляет